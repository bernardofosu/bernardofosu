...
## 🏗️ Flagship Cloud & DevOps Projects
...
**Tech Stack:**  
GitHub Actions • Node.js • Docker • Kubernetes • SonarQube • Trivy • Gitleaks • Linux • Bash • DevSecOps
...
**Tech Stack:**  
Azure DevOps • AKS • ACR • Azure CLI • Kubernetes • YAML Pipelines • RBAC • Linux • Cloud Monitoring
...
**Tech Stack:**  
Splunk Enterprise • Indexer Clustering • Search Heads • Deployment Server • CIM • Syslog • REST APIs • Kubernetes Logs • Linux • Observability
...
**Tech Stack:**  
HashiCorp Vault • Jenkins • AWS EC2 • TLS (Let’s Encrypt) • DNS • Linux • systemd • DevSecOps
...
Python • Go • Node.js • JavaScript • Bash • PowerShell

### ☁️ Cloud & Platforms

AWS • Azure • GCP • EC2 • VPC • IAM • EKS • AKS • CloudWatch • Azure Monitor

### 📦 Containers & Orchestration

Docker • Kubernetes • Helm • Kustomize • Ingress • Container Security
...
Jenkins • GitHub Actions • GitLab CI/CD • Pipeline Security • GitOps

### 📊 Observability

Splunk • Prometheus • Grafana • ELK • OpenTelemetry

### 🔐 Security

IAM • RBAC • HashiCorp Vault • Secrets Management • Compliance Automation
...
⚡ _Fun Fact:_ I automate everything — and then automate the automation 😄
